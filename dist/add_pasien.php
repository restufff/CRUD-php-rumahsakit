...
<html lang="en">
    ...
    <div class="card-body">
            <?php
                ...
                $result = mysqli_query($koneksi, "INSERT INTO pasien(nama,alamat,telepon) VALUES('$nama','$alamat','$telepon')");
                
                if($result){
					echo '<script>alert("Success."); document.location="pasien.php";</script>';
				}else{
